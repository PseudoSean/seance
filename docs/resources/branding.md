...
| `translation.routes`        | Route overrides: `{"<to>": {"<from>" or "*": ["llm", "opus:de-en", "nllb"]}}`, merged over the shipped table one entry at a time.                                                                  |
