...
| `translation.modelBase`     | Base URL of a mirror of the weights. Unset means the public Hugging Face CDN (`huggingface.co`), which some countries and corporate networks block.                                                                                                                                                                                                                                                                    |
...
| `translation.defaultTarget` | The reading language when the user has not chosen one (ISO 639-1). Default: the browser language.                                                                                                                                                                                                                                                                                                                      |
