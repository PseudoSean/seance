...
| `translation.llm`           | `{model, lib}`: a [WebLLM prebuilt model id](https://github.com/mlc-ai/web-llm) (default `Qwen3-1.7B-q4f16_1-MLC`) and, for a model that is not prebuilt, the URL of its compiled `.wasm` library.                                                                                                                                                          |
