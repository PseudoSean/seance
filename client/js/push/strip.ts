...
import {layout, toPlainText} from "../helpers/ircmessageparser/layout";
 ...
 * loses characters; a math span comes back as its TeX source.
 */
export function stripMarkdown(text: string): string {
	return toPlainText(layout(text, {markdown: true})).trim();
}
